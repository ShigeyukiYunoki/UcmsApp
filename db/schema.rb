...
ActiveRecord::Schema.define(version: 2021_05_23_024026) do
  ...
  create_table "medicines", force: :cascade do |t|
    ...
    t.index ["took_medicine_at", "user_id"], name: "index_medicines_on_took_medicine_at_and_user_id", unique: true
